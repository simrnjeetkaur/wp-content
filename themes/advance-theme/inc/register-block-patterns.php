 ...
 * @return void
 */
function advance_theme_register_block_patterns() {
	...
	register_block_pattern_category(
		'theme',
		array( 'label' => esc_html__( 'Theme patterns', 'advance-theme' ) )
	);

}
add_action( 'init', 'advance_theme_register_block_patterns', 9 );
 ...
 * @return void
 */
function advance_theme_unregister_patterns() {
	unregister_block_pattern( 'core/query-small-posts' );
	unregister_block_pattern( 'core/query-large-title-posts' );
	unregister_block_pattern( 'core/query-offset-posts' );
	unregister_block_pattern_category( 'featured' );
}
add_action( 'init', 'advance_theme_unregister_patterns', 10 );
